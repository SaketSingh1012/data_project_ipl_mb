  ...
  .on('end', () => {
    ...
    fs.createReadStream(filePath_delivery )
      ...
      .on('end', () => {
        ...
        const result7_all = calculateStrikeRateByBatsman(deliveriesData, matchesData, uniquePlayers);
        ...
        console.log('Strike rate of batsmen for each season data has been generated and saved to public/output/strikeRateByBatsman.json');
